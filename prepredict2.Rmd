...
It can be seen that in the regression tree model, the most effective variable for the partitioning interval is the departure delay, followed by taxi out, and the arrival delay is also increasing as the departure delay is increased. One third of the samples are in Node 4.
```{r tree}
# step4
## 回归树
